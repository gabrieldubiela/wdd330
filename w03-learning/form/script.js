...
cprinciple.addEventListener("input", (event) => {
    cprinciple.setCustomValidity("");

  if (cprinciple.value !== principle.value) {
    cprinciple.setCustomValidity("The number is not equal to principle.");
  }
  cprinciple.reportValidity(); 
});
